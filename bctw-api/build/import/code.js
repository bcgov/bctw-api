...
exports.addCodeHeader = void 0;
var pg_1 = require("../pg");
var pg_2 = require("../pg");
/*
  - requires json[] in the format:
  {
    code_header_name: '',
    code_header_title: '',
...
var _addCodeHeader = function (idir, headers, onDone) {
    var sql = pg_2.transactionify("select bctw.add_code_header(" + idir + ", " + pg_1.obj_to_pg_array(headers) + ")");
...
var addCode = function (idir, code) {
    console.log('this is a code');
};
var getCode = function (idir) {
    console.log('do it');
};
