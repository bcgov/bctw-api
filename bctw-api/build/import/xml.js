...
var parseXML = function (path) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                e_1 = _a.sent();
                console.log("error reading or parsing xml file: " + e_1);
                return [3 /*break*/, 3];
...
var parseKeyx = function (json) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        keyobj = (_a = json === null || json === void 0 ? void 0 : json.collarKey) === null || _a === void 0 ? void 0 : _a.collar;
        if (!keyobj) {
            console.log('unable to parse xml file');
            return [2 /*return*/, { id: '', comIDList: null, key: '', collarType: '' }];
        }
...
var testxml = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, parseXML(process.env.KEYXSAMPLE || '')];
            case 1:
                parsed = _a.sent();
                return [2 /*return*/, parseKeyx(parsed)];
        }
    });
}); };
