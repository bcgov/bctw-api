...
exports.MISSING_IDIR = exports.query = void 0;
 ...
 */
var query = function (sql, msgIfErr, performAsTransaction) {
    if (performAsTransaction === void 0) { performAsTransaction = false; }
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 6, , 7]);
                    if (!performAsTransaction) return [3 /*break*/, 3];
                    return [4 /*yield*/, pg_1.queryAsyncTransaction(sql)];
                case 2:
                    _a = _b.sent();
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, pg_1.queryAsync(sql)];
                case 4:
                    _a = _b.sent();
                    _b.label = 5;
                case 5:
