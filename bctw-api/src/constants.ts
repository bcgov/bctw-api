...
const PERMISSION_APPROVED_ID = process.env.BCTW_GCNOTIFY_EMAIL_ANIMAL_PERMISSION_APPROVED ??
...
const MORTALITY_EMAIL = process.env.BCTW_GCNOTIFY_EMAIL_MORTALITY_DETECTED ?? 
'55df95d8-042a-4b9b-befc-9a7b3eb9ada2'
const MORTALITY_SMS = process.env.BCTW_GCNOTIFY_SMS_MORTALITY_DETECTED ??
